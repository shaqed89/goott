...
#ftRight{width:600px;}
#face{float:right;bottom:110px;position:relative;}
#face a{position:absolute;}

#insta{left:640px;bottom:110px;position:relative;}
...
#gtHome{float:right;font-size:3em;bottom:60px;position:relative;border-top:1px solid gray;font-family: 'Indie Flower', cursive;}
#gtHome a{color:gray;}
</style>
<script>
	$(function(){
